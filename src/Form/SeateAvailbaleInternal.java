 ...
 * @author mohamed
 */
public class SeateAvailbaleInternal extends javax.swing.JFrame {

    /**
     * Creates new form SeateAvailbale
     */
    Internal in = new Internal();
    public SeateAvailbaleInternal() {
        initComponents();
    ...
    private void BTNShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNShowActionPerformed
        int x = in.getTripeCode(ComboOffer);
        in.setOffer_code(x);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeateAvailbaleInternal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeateAvailbaleInternal().setVisible(true);
            }
        });
    }
