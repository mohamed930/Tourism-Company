 ...
 * @author mohamed
 */
public class SeateAvailbaleUmrah extends javax.swing.JFrame {

    /**
     * Creates new form SeateAvailbale
     */
    Umrah u = new Umrah();
    public SeateAvailbaleUmrah() {
        initComponents();
    ...
    private void BTNShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNShowActionPerformed
        int x = u.getTripeCode(ComboOffer);
        u.setOffer_code(x);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeateAvailbaleUmrah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeateAvailbaleUmrah().setVisible(true);
            }
        });
    }
