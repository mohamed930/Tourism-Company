...
public class SeateNumber1 extends javax.swing.JFrame {
    ...
    {
        if (S.isAvailableInternal(BTN, sent) == false)
        {
        ...
        {
            try{
                InternalSektion.TXTChair.setText(String.valueOf(sent));
                AccompanyingPage.TXTChair.setText(String.valueOf(sent));
            } catch (Exception ex)
            {
                System.out.println();
            }
            try {
                InternalUpdate.TXTChair.setText(String.valueOf(sent));
            } catch (Exception ex)
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeateNumber1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeateNumber1().setVisible(true);
            }
        });
    }
