...
public class SeateNumber4 extends javax.swing.JFrame {
    ...
    public SeateNumber4() {
        ...
        if (Offers.ComboCode.getSelectedItem().equals(""))
        {
            Tools.myMess("من فضلك اختر اسم الرحلة لعرض الكراسى المتاحه بها");
        }
        else
        {
            S.settrip_Name(Offers.ComboCode.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeateNumber4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeateNumber4().setVisible(true);
            }
        });
    }
