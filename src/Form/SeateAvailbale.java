 ...
 * @author mohamed
 */
public class SeateAvailbale extends javax.swing.JFrame {
    ...
    private void BTNShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNShowActionPerformed
        it.setTrip_Name(ComboOffer.getSelectedItem().toString());
        int x = it.getTripeCode();
        if (String.valueOf(x).startsWith("100"))
        {
            in.setOffer_code(x);
            LBLSeate.setText(String.valueOf(48-in.count()));
        }
        else if (String.valueOf(x).startsWith("200"))
        {
            u.setOffer_code(x);
            LBLSeate.setText(String.valueOf(48-u.count()));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeateAvailbale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeateAvailbale().setVisible(true);
            }
        });
    }
