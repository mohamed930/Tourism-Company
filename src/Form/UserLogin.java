...
public class UserLogin extends javax.swing.JFrame {
    ...
    public UserLogin() {
        initComponents();
        Tools.setIcon("src/Photo/UserLogin.jpeg", LBLLogin, 140, 130);
    }
    ...
    private void BTNLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNLoginActionPerformed
       ...
       {
           Tools.myMess("ارجوك اكمل كل الحقول");
       }
       else
       {
           ...
           if (a)
           {
               ...
               EmployeeCataloge.LBLName.setText(UserName);
               String URL = e.GetPhoto();
               Tools.setIcon(URL, EmployeeCataloge.LBLImage, 30, 30);
               in.setEmp_name(UserName);
               this.dispose();
           }
           else
           {
               Tools.myMess("أدخل البيانات صحيحه");
               TXTPass.setText("");
